<template>
  <div
    v-if="isAvailable"
    class="h-10 md:h-12 flex items-center justify-start rounded-md bg-zinc-100 overflow-hidden"
  >
    <!-- inscrease -->
    <button
      @click="increase"
  ...
  <!-- not exist -->
  <p v-else class="text-blue-500">در حال حاضر این کالا در انبار موجود نیست!</p>
</template>

<script>
export default {
  name: "SingleProductQty",
};
</script>
